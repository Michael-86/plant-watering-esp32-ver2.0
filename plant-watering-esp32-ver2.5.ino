...
void setup() {
  ...
  server.on("/update2", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    if (inputMessage1 == "2" && inputMessage2 == "0") {
      ...
      strcpy(autostate, "off");
    }
    if (inputMessage1 == "33" && inputMessage2 == "0") {
      strcpy(pump, "off");
    } else if (inputMessage1 == "33" && inputMessage2 == "1") {
      strcpy(pump, "on");
    }
  });
...
void loop() {
  ...
  if (currentMillis - previousMillis >= interval) {
    ...
    if (strcmp(autostate, "on") == 0 && strcmp(pump, "off") == 0) {
      if (strcmp(jordfuktighet, "För våt") == 0 || strcmp(jordfuktighet, "Är perfekt") == 0) {
        digitalWrite(relay, LOW);
        strcpy(pumprun, "Off");
      } else if (strcmp(jordfuktighet, "För torr") == 0 && (strcmp(ljusstyrka, "Dunkelt") == 0 || strcmp(ljusstyrka, "Mörkt") == 0)) {
        if (h3 < minlvl) {
    ...
    if (strcmp(autostate, "off") == 0 && strcmp(pump, "on") == 0) {
      if (h3 < minlvl) {
        digitalWrite(relay, HIGH);
        strcpy(pumprun, "On");
      } else {
    ...
    } else if (strcmp(autostate, "off") == 0 && strcmp(pump, "off") == 0) {
      digitalWrite(relay, LOW);
      strcpy(pumprun, "Off");
    }
  }
